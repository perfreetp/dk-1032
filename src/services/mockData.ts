...
export const events: Event[] = [
  ...
  },
  {
    ...
    level: 'medium',
    street: '淮海中路',
    position: { lat: 31.22, lng: 121.45 },
    description: '淮海路中段一处井盖发生移位,存在安全隐患',
    status: 'pending',
    reporter: '市民举报',
    createTime: '2026-06-12 09:30:00',
    updateTime: '2026-06-12 09:30:00',
    progress: 0,
    records: [],
  },
  {
    ...
    description: '人民路与中山路交叉口信号灯出现故障,间歇性闪烁',
    status: 'pending',
    reporter: '市民举报',
  ...
  },
  {
    ...
    description: '外滩观光平台局部区域出现积水,影响游客通行',
    status: 'pending',
    reporter: '环卫工人',
    createTime: '2026-06-12 10:15:00',
    updateTime: '2026-06-12 10:15:00',
    progress: 0,
    records: [],
  },
];
